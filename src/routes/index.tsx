...
import StockGraph5 from 'src/screens/Graph/StockGraph5/index.js' 
...
const Index: React.FC = () => {
    return (
        <Drawer.Navigator initialRouteName={'Home'}>
            ...
            <Drawer.Screen name="StockGraph5" component={StockGraph5} options={{headerShown:false,title:"Stock graph5"}}/>
